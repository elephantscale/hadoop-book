 ...
 * database. <br> The Program first creates the necessary tables, populates the
 * input table and runs the mapred job. <br> The input data is a mini access
 * log, with a
 * <code>&lt;url,referrer,time&gt;
