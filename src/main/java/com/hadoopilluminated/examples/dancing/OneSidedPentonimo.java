 ...
 */
public class OneSidedPentonimo extends Pentomino {

    public OneSidedPentonimo() {
    }

    public OneSidedPentonimo(int width, int height) {
        super(width, height);
    }
    ...
    public static void main(String[] args) {
        Pentomino model = new OneSidedPentonimo(3, 30);
