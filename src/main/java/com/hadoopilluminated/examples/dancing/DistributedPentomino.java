package com.hadoopilluminated.examples.dancing;
...
public class DistributedPentomino extends Configured implements Tool {
    ...
    public static class PentMap extends MapReduceBase
        ...
        public void configure(JobConf conf) {
            ...
            pent = (Pentomino) ReflectionUtils.newInstance(conf.getClass("pent.class",
                    OneSidedPentonimo.class),
                    conf);
    ...
    private static void createInputDirectory(FileSystem fs,
        ...
        PrintStream file =
                new PrintStream(new BufferedOutputStream(fs.create(new Path(dir, "part1")), 64 * 1024));
